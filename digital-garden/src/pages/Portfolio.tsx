...
const PhonePrototype = ({ src, title, desc, fullHref }: PhonePrototypeProps) => {
  ...
  useEffect(() => {
    const update = () => {
      if (wrapRef.current) {
        setScale(Math.min(wrapRef.current.clientWidth / 393, 1))
      }
    }
    update()
  ...
  return (
    <div className="card p-0 group overflow-hidden flex flex-col">
      <div ref={wrapRef} className="relative flex-1 w-full overflow-hidden bg-[#F1EFEA]" style={{ aspectRatio: '393/872' }}>
        <iframe
          src={src}
      ...
      <div className="p-4">
        <h4 className="font-display-zh text-base mb-1">{title}</h4>
            ...
            <FadeIn delay={0.2}>
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                  ...
                  {/* 占位：第二个 APP 原型 */}
                  <div className="card p-0 group overflow-hidden flex flex-col">
                    <div className="flex-1 bg-bg-secondary border-b border-border flex items-center justify-center" style={{ aspectRatio: '393/852' }}>
                      <div className="text-center text-text-muted">
                    ...
                    <div className="p-4">
                      <h4 className="font-display-zh text-base mb-1">APP 原型名称</h4>
                  ...
                  {/* 第二行：单列横版网页原型占位符 */}
                  <div className="card p-0 group overflow-hidden sm:col-span-2 lg:col-span-3">
